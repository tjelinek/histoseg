...
# Our implementation fixes a bug which caused errors.


@tf.keras.utils.register_keras_serializable()
class MyClassToken(tf.keras.layers.Layer):
...
@tf.keras.utils.register_keras_serializable()
class MyAddPositionEmbs(tf.keras.layers.Layer):
...
@tf.keras.utils.register_keras_serializable()
class MyMultiHeadSelfAttention(tf.keras.layers.Layer):
...
@tf.keras.utils.register_keras_serializable()
class MyTransformerBlock(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        self.att = MyMultiHeadSelfAttention(
            num_heads=self.num_heads,
